...
class RoomData {
  ...
  static const RoomDetailData secondRoom = RoomDetailData(
      title: "干物の部屋", imgPath: "images/background/2ndStage_background.png");
  static const RoomDetailData thirdRoom = RoomDetailData(
      title: "調理室", imgPath: "images/background/3rdStage_background.png");
  static const RoomDetailData forthARoom = RoomDetailData(
      title: "細道", imgPath: "images/background/4thStage_background.png");
  static const RoomDetailData forthBRoom = RoomDetailData(
      title: "機械室", imgPath: "images/background/4thStage_background.png");
  static const RoomDetailData endingRoom = RoomDetailData(
      title: "主人の書斎", imgPath: "images/background4thStage_background.png");
