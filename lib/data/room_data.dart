...
class RoomData {
  static const RoomDetailData tutorialRoom = RoomDetailData(
      title: "始まりの部屋",
      imgPath: "images/background/tutorial_background.png",
      hints: [""]);
  static const RoomDetailData firstRoom = RoomDetailData(
      title: "タマゴの部屋",
      imgPath: "images/background/1stStage_background.png",
      hints: ["茶色の卵は正直です。", "", "答え:黄色の卵"]);
  static const RoomDetailData secondRoom = RoomDetailData(
      title: "干物の部屋",
      imgPath: "images/background/2ndStage_background.png",
      hints: [
        "生物図鑑の後ろになにかがある...?",
  ...
  static const RoomDetailData thirdRoom = RoomDetailData(
      title: "調理室",
      imgPath: "images/background/3rdStage_background.png",
      hints: [
        "光の三原色と色の三原色の表が貼ってある...",
  ...
  static const RoomDetailData forthARoom = RoomDetailData(
      title: "細道",
      imgPath: "images/background/4thStage_background.png",
      hints: []);
  ...
  static const RoomDetailData endingRoom = RoomDetailData(
      title: "主人の書斎",
      imgPath: "images/background4thStage_background.png",
      hints: ["B=2"]);
